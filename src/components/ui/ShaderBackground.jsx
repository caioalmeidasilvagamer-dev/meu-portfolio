...
// "Smoke" shader do 21st.dev Shader Builder — WebGL1 puro, zero dependências
...
export default function ShaderBackground() {
  ...
  useEffect(() => {
    ...
    const colorsFlat = new Float32Array(UNIFORMS.colors.flat());
    gl.uniform3fv(uni.colors, colorsFlat);
