      ...
      >
        ...
        <Suspense fallback={null}>
          ...
          <Environment resolution={512} background={false}>
            ...
            {/* Key Softbox — painel branco grande */}
            <Lightformer form="rect" intensity={5} color="#ffffff" scale={[10, 6, 1]} position={[4, 5, 3]} target={[0, 0, 0]} />
            {/* Fill Softbox — iluminação suave lateral */}
            <Lightformer form="rect" intensity={3} color="#ffffff" scale={[8, 6, 1]} position={[-5, 2, 2]} target={[0, 0, 0]} />
            {/* Top light — ilumina superior */}
            <Lightformer form="rect" intensity={2} color="#ffffff" scale={[6, 4, 1]} position={[0, 6, 0]} target={[0, 0, 0]} />
            {/* Rim Ring — silhueta traseira */}
            <Lightformer form="ring" intensity={2} color="#ffffff" scale={4} position={[0, 3, -6]} target={[0, 0, 0]} />
          </Environment>
